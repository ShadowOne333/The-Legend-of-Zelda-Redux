...
* Automap Plus, but modified to have 1/4 heart decrements instead of 1/8 (this is needed in order to make space in sprite PPU for custom HUD elements)
...
* **vailkyte** - For the Dungeon Automap fix for Dungeon 9.
