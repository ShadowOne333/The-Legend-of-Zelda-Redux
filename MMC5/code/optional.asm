...
// Make the Blue Ring/Tunic even more vivid (based on Asaki's hack)
//incsrc code/optional/BluerTunic.asm
...
// Remove THE HYRULE FANTASY subtitle
//incsrc code/optional/RemoveHyruleFantasySubtitle.asm
