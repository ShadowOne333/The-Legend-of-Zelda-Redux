...
//Orginal routine to load HUD preset. You will find the preset Format furter down
...
// Make rupee counter decimal and extanded to 999. Also we need to count in hex too since 
// Stores would make way more work otherwise.
...
FrameCheck:
	...
	lsr                   
	bcs EndFrameCheck
	jmp $6D05		// Jump over free newly avalible space
EndFrameCheck:
	rts
